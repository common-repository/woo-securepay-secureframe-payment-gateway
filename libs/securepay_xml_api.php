...
class securepay_xml_transaction {
    ...
    private function createXMLTransactionRequestString() {
        ...
        $x = '<?xml version="1.0" encoding="UTF-8" ?>' .
                '<SecurePayMessage>' .
                '<MessageInfo>' .
                '<messageID>' . htmlentities($this->getTxnReference() . date('His') . current(preg_split('/\s/', microtime()))) . '</messageID>' .
